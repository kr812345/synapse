...
class HNWorker(BaseAgent):
    ...
    def can_handle(self, task_description: str) -> bool:
        return "hackernews" in task_description.lower() or "hn" in task_description.lower()

    async def execute(self, task: Any) -> Any:
        return {"status": "success", "task": task, "result": "mocked hn research"}
