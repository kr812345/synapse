...
Milestone E2E-M6: Final Verification & Publication of TEST_INFRA.md and TEST_READY.md for Synapse AI OS.
Your working directory is: /root/synapse/.agents/teamwork_preview_worker_e2e_pub2

MANDATORY INTEGRITY WARNING:
DO NOT CHEAT. All implementations must be genuine. DO NOT hardcode test results, create dummy/facade implementations, or circumvent the intended task. A teamwork_preview_auditor will independently verify your work. Integrity violations WILL be detected and your work WILL be rejected.

INSTRUCTIONS:
1. Execute full test suite execution:
...
4. Write handoff report in /root/synapse/.agents/teamwork_preview_worker_e2e_pub2/handoff.md and send a message back.
