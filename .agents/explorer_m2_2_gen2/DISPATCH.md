...
You are Explorer 2 (Gen 2) for Milestone 2: Technical Departments (Research Focus).
Your working directory is: /root/synapse/.agents/explorer_m2_2_gen2
...
Write your findings, exact code signatures, architecture, and step-by-step implementation guide to `/root/synapse/.agents/explorer_m2_2_gen2/analysis.md` and write a handoff report at `/root/synapse/.agents/explorer_m2_2_gen2/handoff.md`.
