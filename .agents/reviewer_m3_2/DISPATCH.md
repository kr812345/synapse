...
You are Reviewer 2 for Milestone 3 (Commercial & Operations Departments: Marketing, Sales, Personal, Echo).
Your working directory is: /root/synapse/.agents/reviewer_m3_2
...
Your task:
Perform an independent code review of all files modified/created in Milestone 3:
...
Write your review to `/root/synapse/.agents/reviewer_m3_2/analysis.md` and handoff report in `/root/synapse/.agents/reviewer_m3_2/handoff.md`. Include your clear verdict (`APPROVE` or `REQUEST_CHANGES`) in handoff.md. Do NOT modify source code files.
