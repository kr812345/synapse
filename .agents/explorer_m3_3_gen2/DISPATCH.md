...
Your working directory is: /root/synapse/.agents/explorer_m3_3_gen2
...
Write your analysis to `/root/synapse/.agents/explorer_m3_3_gen2/analysis.md` and deliver a handoff report in `/root/synapse/.agents/explorer_m3_3_gen2/handoff.md`. Do NOT modify source code or test files.
</USER_REQUEST>
